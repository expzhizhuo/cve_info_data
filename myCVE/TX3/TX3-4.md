...
User control pointer parameter ***time*** in web requesting; ***v14*** is a pointer parameter on the stack, and using `_isoc99_sscanf` to copy ***v9*** to ***v14*** without length limit will cause stack overflow.
