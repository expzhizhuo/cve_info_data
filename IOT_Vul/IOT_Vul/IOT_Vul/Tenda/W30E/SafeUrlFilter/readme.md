...
![](https://github.com/z1r00/IOT_Vul/blob/main/Tenda/W30E/SafeUrlFilter/img/2.png)

In /goform/SafeUrlFilter, the page will be spliced into s by sprintf. It is worth noting that there is no size check, which leads to a stack overflow vulnerability.
...
payload = b"http://192.168.10.103/goform/SafeUrlFilter/?" + cmd
