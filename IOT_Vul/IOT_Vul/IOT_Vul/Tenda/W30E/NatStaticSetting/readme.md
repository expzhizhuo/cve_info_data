...
![](https://github.com/z1r00/IOT_Vul/blob/main/Tenda/W30E/NatStaticSetting/img/2.png)

In /goform/NatStaticSetting, the page will be spliced into s by sprintf. It is worth noting that there is no size check, which leads to a stack overflow vulnerability.
...
payload = b"http://192.168.10.103/goform/NatStaticSetting/?" + cmd
