...
![](https://github.com/z1r00/IOT_Vul/blob/main/Tenda/W6-S/WifiMacFilterSet/img/2.png)

In /goform/WifiMacFilterSet, when wl_radio is 0, the index will be spliced into v12 by sprintf. It is worth noting that there is no size check, which leads to a stack overflow vulnerability.
...
target_url = 'http://192.168.10.105/goform/WifiMacFilterSet'
