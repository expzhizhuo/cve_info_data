...
![](https://github.com/z1r00/IOT_Vul/blob/main/Tenda/W6-S/SysToolReboot/img/2.png)

In /goform/SysToolReboot, tpi_systool_handle(0) will cause the entire router to reboot without authorization
...
target_url = 'http://192.168.10.105/goform/SysToolReboot'
