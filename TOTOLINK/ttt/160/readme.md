...
![image-20220808153854101](img/image-20220808153854101.png)

程序通过获取参数iptvVer中的内容传递给v19，之后将v19带入到Uci_Set_Str函数中

![image-20220808153912200](img/image-20220808153912200.png)

在Uci_Set_Str函数中，通过snprintf函数，将a4匹配到的内容格式化进v11，之后将v11带入cstesystem函数中

![image-20220808153927985](img/image-20220808153927985.png)
