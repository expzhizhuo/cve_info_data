...
![image-20220720192426079](img/image-20220720192426079.png)

程序通过获取city参数下的内容传递给v12，之后将v12带入到Uci_Set_Str函数中

![image-20220720192442791](img/image-20220720192442791.png)

在Uci_Set_Str函数中，通过snprintf函数，将a4匹配到的内容格式化进v11，之后将v11带入cstesystem函数中

![image-20220720192457382](img/image-20220720192457382.png)
