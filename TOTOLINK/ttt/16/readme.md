...
![image-20220720161146266](img/image-20220720161146266.png)

程序通过获取rsabits参数下的内容传递给v8，之后带入到Uci_Set_Str函数中

![image-20220720161209024](img/image-20220720161209024.png)

在Uci_Set_Str函数中，通过snprintf函数，将a4匹配到的内容格式化进v11，之后将v11带入cstesystem函数中

![image-20220720161236299](img/image-20220720161236299.png)
