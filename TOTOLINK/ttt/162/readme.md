...
![image-20220808222508463](img/image-20220808222508463.png)

程序通过获取参数ipPhonePri中的内容传递给v21，之后将v21带入到Uci_Set_Str函数中

![image-20220808222524667](img/image-20220808222524667.png)

在Uci_Set_Str函数中，通过snprintf函数，将a4匹配到的内容格式化进v11，之后将v11带入cstesystem函数中

![image-20220808222542602](img/image-20220808222542602.png)
