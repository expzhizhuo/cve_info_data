...
![image-20220720193236468](img/image-20220720193236468.png)

程序通过获取ou参数下的内容传递给v14，之后将v14带入到Uci_Set_Str函数中

![image-20220720193253159](img/image-20220720193253159.png)

在Uci_Set_Str函数中，通过snprintf函数，将a4匹配到的内容格式化进v11，之后将v11带入cstesystem函数中

![image-20220720193311239](img/image-20220720193311239.png)
