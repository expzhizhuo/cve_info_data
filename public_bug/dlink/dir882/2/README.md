...
In prog.cgi, we can find the code details in sub_459F88,the program passes the contents obtained by the /SetQuickVPNSettings/PSK parameter to V5.

![](pic/code1.png "")

The V5 parameter is called by the function decrypt_aes (). In the decrypt_aes () function, it is passed to the sub_427184 ().
