...
In prog.cgi,We can find the details in the code of setting PPPoE function in sub_46A10C,the program passes the contents obtained by the /SetWan2Settings/Password parameter to V33.
