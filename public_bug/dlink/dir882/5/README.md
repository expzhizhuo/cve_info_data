...
In prog.cgi, we can find the code details in sub_44B424,the program passes the contents obtained by the /SetIPv6PppoeSettings/IPv6_PppoePassword parameter to V44.
