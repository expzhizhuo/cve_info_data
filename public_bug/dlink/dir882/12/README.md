...
In prog.cgi,We can find the details in the code of setting PPTP function in sub_46C6CC,the program passes the contents obtained by the /SetWan3Settings/Password parameter to V37.

![](pic/code1.png "")

The V37 parameter is called by the function decrypt_aes (). In the decrypt_aes () function, it is passed to the sub_427184 ().
