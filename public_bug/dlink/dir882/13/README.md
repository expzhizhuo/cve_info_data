...
In prog.cgi,We can find the details in the code of setting L2TP function in sub_46C6CC,the program passes the contents obtained by the /SetWan3Settings/Password parameter to V47.
