...
In prog.cgi, we can find the code details in sub_498A78,the program passes the contents obtained by the Password parameter to V7.

![](pic/code1.png "")

The V7 parameter is called by the function decrypt_aes (). In the decrypt_aes () function, it is passed to the sub_427184 ().
