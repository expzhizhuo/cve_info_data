...
In prog.cgi,We can find the details in the code of setting L2TP function in sub_466B38,the program passes the contents obtained by the /SetWanSettings/Password parameter to V109.
