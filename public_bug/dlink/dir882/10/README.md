...
In prog.cgi,We can find the details in the code of setting L2TP function in sub_46A10C,the program passes the contents obtained by the /SetWan2Settings/Password parameter to V48.

![](pic/code1.png "")

The V48 parameter is called by the function decrypt_aes (). In the decrypt_aes () function, it is passed to the sub_427184 ().
