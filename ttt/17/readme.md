...
![image-20220720191136029](img/image-20220720191136029.png)

程序通过获取dayvalid参数中的内容传递给v9，之后带入到Uci_Set_Str函数中

![image-20220720191201047](img/image-20220720191201047.png)

在Uci_Set_Str函数中，通过snprintf函数，将a4匹配到的内容格式化进v11，之后将v11带入cstesystem函数中

![image-20220720191220418](img/image-20220720191220418.png)
