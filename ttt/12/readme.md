...
![image-20220719203834480](img/image-20220719203834480.png)

程序通过获取username参数中的内容传递给v51，之后将v51带入到Uci_Set_Str函数中

![image-20220719203852685](img/image-20220719203852685.png)

在Uci_Set_Str函数中，通过snprintf函数，将a4匹配到的内容格式化进v11，之后将v11带入cstesystem函数中

![image-20220719203912246](img/image-20220719203912246.png)
