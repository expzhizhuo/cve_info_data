...
First, find the cross reference of saveparentcontrolinfo through string search

![image-20220214123951775](img/image-20220214123951775.png)

![image-20220214123957966](img/image-20220214123957966.png)

Get the content of the parameter and pass it to Src
In the next review, it is found that the strcpy function directly copies the obtained content to the v18 + 2 stack, which has a stack overflow vulnerability

![image-20220214124020145](img/image-20220214124020145.png)
...
![image-20220214123855759](img/image-20220214123855759.png)
