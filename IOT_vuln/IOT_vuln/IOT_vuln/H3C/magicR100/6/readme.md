...
![image-20220513173735732](img/image-20220513173735732.png)

The content obtained by the program through param parameter is passed to V9, and then the matched content is passed to the stack of V11 through sscanf function. There is no size check, and there is a stack overflow vulnerability.
