...
![image-20220513173103935](img/image-20220513173103935.png)

The content obtained by the program through the go parameter is passed to V10, and then V10 is directly copied into DWORD through the strcpy function_ In 4aa078 + 192, there is no size check, and there is a buffer overflow vulnerability
