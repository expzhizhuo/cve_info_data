...
![image-20220513172420370](img/image-20220513172420370.png)

The content obtained by the program through the go parameter is passed to V10, and then V10 is copied into DWORD_ In 4aa078, the size of V10 is not checked, and there is a buffer overflow vulnerability.
